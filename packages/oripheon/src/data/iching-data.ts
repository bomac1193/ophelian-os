/**
 * I Ching Hexagram Data & Derivation
 *
 * All 64 hexagrams with line patterns, plus a derivation function
 * that maps personality axes to a hexagram reading.
 */
...
export interface HexagramReading {
  ...
  transformingHexagram: Hexagram | null;
 ...
 * Line 5: average of orderChaos and mercy
 * Line 6: average of introvert and faith
 *
